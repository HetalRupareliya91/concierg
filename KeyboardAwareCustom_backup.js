...
function KeyboardAwareHOC(
  ...
  return class
    ...
    render() {
      const { enableOnAndroid, contentContainerStyle, onScroll,isChat } = this.props
      ...
      return (
        <ScrollableComponent
          ...
          contentInset={{ bottom:isChat===true? this.state.keyboardSpace: this.state.keyboardSpace -100 }}
